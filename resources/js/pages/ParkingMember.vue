  ...
  <div>
    ...
    >
      ...
      <el-table-column
        ...
        header-align="center"
      >
        <template slot-scope="scope">{{scope.row.paid ? 'BERBAYAR' : 'GRATIS'}}</template>
      </el-table-column>
      ...
      <el-table-column label="Plat Nomor" show-overflow-tooltip min-width="150px">
        <template slot-scope="scope">{{scope.row.vehicles.map(v => v.plate_number).join(', ')}}</template>
      </el-table-column>
      <el-table-column
        prop="register_date"
        label="Tgl Daftar"
        ...
        header-align="center"
      >
        <template slot-scope="scope">{{scope.row.register_date | readableDate}}</template>
      </el-table-column>
      <el-table-column
        prop="expiry_date"
        ...
        header-align="center"
      >
        <template slot-scope="scope">{{scope.row.expiry_date | readableDate}}</template>
      </el-table-column>
      <el-table-column
        prop="fare"
        label="Tarif"
        ...
        align="right"
      >
        <template slot-scope="scope">Rp. {{scope.row.fare | formatNumber}}</template>
      </el-table-column>
      <el-table-column
        prop="billing_cycle"
        label="Siklus Bayar"
      ...
      >
        <template
          slot-scope="scope"
        >{{scope.row.billing_cycle}} {{$store.state.siklus.find(s => s.value == scope.row.billing_cycle_unit).label}}</template>
      </el-table-column>
      <el-table-column
        prop="phone"
        label="Nomor HP"
      ...
      <el-table-column
        ...
        min-width="150px"
      >
        <template slot-scope="scope">{{scope.row.last_transaction | readableDate}}</template>
      </el-table-column>
      <el-table-column
          ...
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item
                ...
                @click.native.prevent="() => { selectedData = scope.row; showDetail = true; }"
        ...
        <el-row :gutter="30">
          <el-col :span="8">
            <el-form-item label="Group" :class="formErrors.group_member_id ? 'is-error' : ''">
              ...
              >{{formErrors.group_member_id[0]}}</div>
            </el-form-item>
            ...
            <el-form-item label="Nomor Kartu" :class="formErrors.card_number ? 'is-error' : ''">
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.card_number"
              >{{formErrors.card_number[0]}}</div>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
            ...
            >
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.register_date"
              >{{formErrors.register_date[0]}}</div>
            </el-form-item>
          ...
          <el-col :span="8">
            ...
            >
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.billing_cycle"
              >{{formErrors.billing_cycle[0]}}</div>
            </el-form-item>
            ...
            >
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.expiry_date"
              >{{formErrors.expiry_date[0]}}</div>
            </el-form-item>
            ...
            <el-form-item label="Status">
              ...
              <div
                class="el-form-item__error"
                v-if="formErrors.is_active"
              >{{formErrors.is_active[0]}}</div>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    store() {
      ...
      axios
        .post("/parkingMember", this.formModel)
        .then(r => {
          this.showForm = false;
          this.$message({
    ...
    update() {
      ...
      this.formModel.expiry_date = this.expiry_date;
      axios
        .put("/parkingMember/" + this.formModel.id, this.formModel)
        .then(r => {
          this.showForm = false;
          this.$message({
            message: "Data berhasil disimpan.",
