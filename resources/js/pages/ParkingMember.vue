<template>
    <div>
        ...
        @sort-change="sortChange">
            ...
            <el-table-column prop="email" label="Email" sortable="custom" show-overflow-tooltip></el-table-column>
            <el-table-column prop="phone" label="Phone" sortable="custom" show-overflow-tooltip></el-table-column>
            <el-table-column prop="plate_number" label="Plat Number" sortable="custom" show-overflow-tooltip></el-table-column>
            <el-table-column prop="card_number" label="Card Number" sortable="custom" show-overflow-tooltip></el-table-column>
            <el-table-column prop="vehicle_type" label="Type" sortable="custom" show-overflow-tooltip></el-table-column>
            <el-table-column prop="expiry_date" label="Expiry Date" sortable="custom" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="last_transaction" label="Last Trx" sortable="custom"></el-table-column>
        ...
        <el-dialog :visible.sync="showForm" :title="!!formModel.id ? 'EDIT MEMBER' : 'ADD NEW MEMBER'" width="550px" v-loading="loading" :close-on-click-modal="false">
            ...
            <el-form label-width="170px">
                ...
                <el-form-item label="Expiry Date" :class="formErrors.expiry_date ? 'is-error' : ''">
                    <el-date-picker :disabled="!!formModel.id" format="dd-MMM-yyyy" value-format="yyyy-MM-dd" placeholder="Expiry Date" v-model="formModel.expiry_date" style="width:100%"></el-date-picker>
