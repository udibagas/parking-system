      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td class="td-value">{{member.name}}</td>
          </tr>
          <tr>
            <td class="td-label">Nomor HP</td>
            <td class="td-value">{{member.phone}}</td>
          </tr>
          <tr>
            <td class="td-label">Nomor Kartu</td>
            <td class="td-value">{{member.card_number}}</td>
          </tr>
          <tr>
            <td class="td-label">Jenis</td>
            <td class="td-value">{{member.paid ? 'Berbayar' : 'Gratis'}}</td>
          </tr>
          <tr>
            <td class="td-label">Tanggal Daftar</td>
            <td class="td-value">{{member.register_date}}</td>
          </tr>
          <tr>
            <td class="td-label">Tanggal Kedaluarsa</td>
            <td class="td-value">{{member.expiry_date}}</td>
          </tr>
          <tr>
            <td class="td-label">Siklus Pembayaran</td>
            <td
              class="td-value"
            >{{member.billing_cycle}} {{$store.state.siklus.find(s => s.value == member.billing_cycle_unit).label}}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="td-value">{{member.last_transaction}}</td>
          </tr>
          <tr>
            <td class="td-label">Status</td>
            <td class="td-value">{{member.is_active ? 'Aktif' : 'Nonaktif'}}</td>
          </tr>
        </tbody>
      </table>
    </el-col>
